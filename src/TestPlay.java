...
public class TestPlay {
	...
	private void tieBreakGame() {
		playerOneInLead();
		winGame(playerTwo, "6-6");
		tennis.gameSet();
	}

	private void playerOneInLead() {
		winGame(playerOne, "1-0");
		tennis.gameSet();
		winGame(playerTwo, "1-1");
		tennis.gameSet();
		winGame(playerTwo, "1-2");
		tennis.gameSet();
		winGame(playerTwo, "1-3");
		tennis.gameSet();
		winGame(playerOne, "2-3");
		tennis.gameSet();
		winGame(playerOne, "3-3");
		tennis.gameSet();
		winGame(playerOne, "4-3");
		tennis.gameSet();
		winGame(playerTwo, "4-4");
		tennis.gameSet();
		winGame(playerTwo, "4-5");
		tennis.gameSet();
		winGame(playerOne, "5-5");
		tennis.gameSet();
		winGame(playerOne, "6-5");
		tennis.gameSet();
	}
	...
	public void matchPlay14_PlayerOneWins() {
		setupAssertPlayers();
		playerOneInLead();
		winGame(playerOne, "7-5, Winner Rodel");
		tennis.gameSet();
	}
